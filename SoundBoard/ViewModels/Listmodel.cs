...
namespace SDP.ViewModels
{
    public class Listmodel : List<listcourse>
    {
        ...
        public List<listcourse> LoadRelatedCourses(int selectedindex)
        {
            ...
            {
                case 0:
                    relatedcourse.Add(new listcourse("Big Data", "Assets/images/1.jpg"));
                ...
                case 1:
                   ...
                   // relatedcourse.Add(new listcourse("C#", "Assets/images/14.jpg"));
                    break;
                case 2:
                    relatedcourse.Add(new listcourse("Linux Programming", "Assets/images/16.jpg"));
                ...
                case 11:
                    ...
                    break;
                case 12:
                    relatedcourse.Add(new listcourse("Big Data", "Assets/images/5.jpg"));
        ...
        List<listcourse> BuildCollection()
        {
            ...
            datacollection.Add(new listcourse("Big Data", "/Assets/images/1.jpg"));
            datacollection.Add(new listcourse("Python", "/Assets/images/2.jpg"));
            datacollection.Add(new listcourse("Linux Administration", "/Assets/images/3.jpg"));
            ...
            datacollection.Add(new listcourse("JavaScript", "/Assets/images/13.jpg"));
            ...
            datacollection.Add(new listcourse("Web Architecture", "/Assets/images/17.jpg"));
